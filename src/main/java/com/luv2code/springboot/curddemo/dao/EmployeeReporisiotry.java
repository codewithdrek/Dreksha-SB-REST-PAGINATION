...
//no need to write any code
    ...
    //http://localhost:8080/magic-api/employee?page=1@size=3
    //http://localhost:8080/magic-api/employee?sort=lastName ,Desc
    //http://localhost:8080/magic-api/employee?sort=firstName ,Asec
}
